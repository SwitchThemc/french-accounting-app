...
const labels: Record<Locale, Record<string, string>> = {
  en: {
    ...
    authBenefitOne: "French-ready invoices, purchases, VAT and exports.",
    authBenefitTwo: "PWA receipt scanning and local OCR for faster capture.",
    authBenefitThree: "Open-source contract, approval and reporting workflows.",
  ...
  fr: {
    setup: "configuration",
    createWorkspace: "Créer votre espace comptable",
    refreshing: "Actualisation de l'espace...",
    language: "Langue",
    refresh: "Actualiser",
    signOut: "Se déconnecter",
    authTitle: "Comptabilité quotidienne pour une petite activité française.",
    authSubtitle: "Factures, achats, trésorerie, TVA et exports dans un vrai livre comptable.",
    authBenefitOne: "Factures, achats, TVA et exports prêts pour la France.",
    authBenefitTwo: "Scan PWA des justificatifs et OCR local pour saisir plus vite.",
    authBenefitThree: "Contrats, approbations et rapports open-source.",
    ...
    companyProfileHelp: "Le régime pilote la TVA, les livres et les exports.",
    ...
    creating: "Création...",
    createWorkspaceButton: "Créer l'espace",
    ...
    recentActivityHelp: "Dernières factures et dépenses du livre comptable.",
    newInvoice: "Nouvelle facture",
    newInvoiceHelp: "Créer manuellement, joindre un fichier ou scanner une photo pour préremplir.",
    invoiceUploadScan: "Import et scan de facture",
    invoiceUploadHelp: "OCR local gratuit pour les images. Les PDF sont conservés en pièces jointes.",
    scanUpload: "Scanner",
    scanning: "Scan...",
    ...
    detectedDocument: "Document détecté",
    ...
    receiptScanHelp: "Capture depuis la PWA et préremplissage fournisseur, montant, TVA et catégorie.",
    scanReceipt: "Scanner le justificatif",
    detectedReceipt: "Justificatif détecté",
    logPurchase: "Saisir un achat",
    logPurchaseHelp: "Suit fournisseur, catégorie, TVA et moyen de paiement.",
    ...
    purchaseRegisterHelp: "Les achats micro-BIC éligibles peuvent être exportés depuis cette liste.",
    generateContract: "Générer un contrat",
    generateContractHelp: "Utiliser des modèles locaux ou un modèle open-source Ollama.",
    aiProvider: "Fournisseur IA open-source",
    aiProviderHelp: "Lancez Ollama localement ou auto-hébergez-le. Sinon l'app utilise les modèles locaux.",
    localTemplate: "Modèle local",
    noLinkedClient: "Aucun client lié",
    english: "Anglais",
    frenchGuidance: "Guidage français",
    currency: "Devise",
    ...
    deliverables: "Livrables / périmètre",
    specialTerms: "Conditions particulières",
    generateWithOllama: "Générer avec Ollama",
    generateContractButton: "Générer le contrat",
    ...
    legalReviewHelp: "Vérifiez que le brouillon est complet avant approbation ou signature.",
    ...
    grantBudgetPipelineHelp: "Budgets éligibles et montants demandés depuis Release Manager.",
    grantReadbackHint: "Les éditions comptables sont enregistrées ici et deviennent visibles dans Release Manager seulement quand Release Manager relit ce dossier via le endpoint sync signé.",
    expectedFunding: "Financement attendu",
    requestedFunding: "Financement demandé",
    synced: "Synchronisé",
    openReleaseManager: "Ouvrir Release Manager",
    accountingNotes: "Notes comptables",
    pricingDecision: "Décision tarifaire",
    save: "Enregistrer",
    ...
    inviteLinksHelp: "Créer un lien sécurisé pour collaborateurs, comptables ou relecteurs.",
    ...
    mentionsHelp: "Utilisez @email, @nom avant le domaine email, ou @all dans les notes, descriptions, détails d'approbation, contrats, subventions et libellés bancaires pour notifier l'équipe via le hub.",
    meetingInvites: "Invitations réunion",
    meetingInvitesHelp: "Envoyer une invitation email compatible calendrier et une notification hub aux collaborateurs ou invités externes.",
    attendees: "Participants",
    meetingTitle: "Titre de réunion",
    meetingDescription: "Description",
    meetingLocation: "Lieu ou lien vidéo",
    startsAt: "Début",
    endsAt: "Fin",
    sendMeetingInvite: "Envoyer invitation",
    meetingInviteSent: "Invitation envoyée.",
    approvalFlows: "Circuits d'approbation",
    approvalFlowsHelp: "Suivre les décisions sur contrats, factures, dépenses et changements.",
    title: "Titre",
    details: "Détails",
    ...
    manualBankLineHelp: "Les connecteurs PSD2 écriront ensuite dans cette même table.",
    direction: "Sens",
    amount: "Montant",
    counterparty: "Tiers",
    label: "Libellé",
    bookingDate: "Date d'opération",
    addBankLine: "Ajouter la ligne",
    bankFeed: "Flux bancaire",
    bankFeedHelp: "Les lignes sont prêtes pour rapprochement et règles.",
    moneyIn: "Entrée",
    moneyOut: "Sortie",
    livreRecettes: "Livre des recettes",
    registreAchats: "Registre des achats",
    vatDue: "TVA due",
    exportStatus: "État des exports",
    exportStatusHelp: "Le FEC est modélisé en base et doit être généré par un traitement serveur.",
    livreRecettesCsv: "Livre recettes CSV",
    registreAchatsCsv: "Registre achats CSV",
    taxAnalyticsPdf: "Analytics fiscales PDF",
    finalRateRules: "Nécessite les taux définitifs avant déclaration",
    readyNow: "Prêt maintenant",
    source: "Source",
    yes: "Oui",
    partial: "Partiel",
    schemaReady: "Schéma prêt",
    payloadReady: "Champ payload prêt",
    reportsRevenueHelp: "Comptes de produits postés",
    reportsExpensesHelp: "Comptes de charges postés",
    netResult: "Résultat net",
    balanceCheck: "Contrôle balance",
    balanceCheckHelp: "Actif moins passif/capitaux/resultat",
    profitAndLoss: "Compte de résultat",
    profitAndLossHelp: "Généré depuis les écritures comptables postées.",
    ...
    liabilitiesEquityResult: "Passif + capitaux + résultat",
    imbalance: "Écart",
    accountBalances: "Balances des comptes",
    accountBalancesHelp: "Solde détaillé par classe du plan comptable français.",
    account: "Compte",
    class: "Classe",
    debit: "Débit",
    credit: "Crédit",
    ...
    pdpConnectorHelp: "Mettre en file les e-factures pour un PDP accrédité ou un export manuel.",
    ...
    queueInvoiceHelp: "Crée un enregistrement d'envoi pour un futur traitement PDP.",
    invoice: "Facture",
    connector: "Connecteur",
    format: "Format",
    queueDelivery: "Mettre en file",
    reformReadiness: "Préparation réforme",
    reformReadinessHelp: "Suit les hypothèses de l'architecture française d'e-facturation.",
    area: "Zone",
    status: "Statut",
    receivingSupplierInvoices: "Réception des factures fournisseurs",
    issuingEInvoices: "Émission e-factures PME/micro",
    exchangeRoute: "Canal d'échange",
    supportedPayloadRecords: "Formats suivis",
    nextIntegrationStep: "Prochaine intégration",
    requiredAll2026: "Obligatoire pour toutes les entreprises le 2026-09-01",
    requiredPme2027: "Obligatoire à partir du 2027-09-01",
    accreditedPdp: "PDP accrédité ; le PPF n'est pas le portail direct entreprise",
    facturxQueue: "Métadonnées de file Factur-X, UBL, CII",
    addPdpAdapter: "Ajouter un adaptateur API PDP et une référence coffre credentials",
...
async function downloadInvoicePdf(invoice: Invoice, contact: Contact | undefined, lines: InvoiceLine[], company: Company) {
  ...
  y += 3;
  pdfText(pdf, "Paiement à réception sauf conditions convenues. Pénalités de retard selon conditions légales applicables.", pdfLayout.margin, y, pdfContentWidth(pdf));
...
async function downloadTaxAnalyticsPdf({
  ...
  const { jsPDF } = await import("jspdf");
  const pdf = new jsPDF();
  let y = pdfDocumentHeader(pdf, "Analytics fiscales", `Généré le ${today}`, company);
...
async function downloadReportsPdf({
  ...
  const { jsPDF } = await import("jspdf");
  const pdf = new jsPDF();
  let y = pdfDocumentHeader(pdf, "Rapports financiers", `Généré le ${today}`, company);
      ...
      <section className="auth-panel">
        <div className="auth-story">
          <div className="auth-logo">
            ...
            <span>Compta Solo</span>
          </div>
          <p className="eyebrow">Open-source accounting</p>
          <h1>{t.authTitle}</h1>
